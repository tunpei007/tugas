...
<form action="p8.php" method="get">
	...
	<input type="radio" name="p7" value="1">Ya </br>
	<input type="radio" name="p7" value="0.1">Kurang Tahu </br>
	<input type="radio" name="p7" value="0.6">Mungkin </br>
	<input type="radio" name="p7" value="-0.5">Mungkin Tidak </br>
	<input type="radio" name="p7" value="-1">Tidak </br>
