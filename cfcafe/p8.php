...
<?php
echo 'Apakah Masa Mendekati lebaran ? <br>';
?>
<form action="hasil.php" method="get">
			...
			<input type="hidden" name="p6" value="<?=$_GET['p6']?>">
			<input type="hidden" name="p7" value="<?=$_GET['p7']?>">
					
	<input type="radio" name="p8" value="1">Ya </br>
	<input type="radio" name="p8" value="0.1">Kurang Tahu  </br>
	<input type="radio" name="p8" value="0.6">Mungkin </br>
	<input type="radio" name="p8" value="-0.5">Mungkin Tidak </br>
	<input type="radio" name="p8" value="-1">Tidak </br>
